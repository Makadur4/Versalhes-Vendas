...
export default function () {
    ...
    const AbrirDuvida1 = () => {
        setSeta1((prev) =>
        prev ===  "/svg/icone_seta_direita.svg" ? "/svg/icone_seta_baixo.svg" : "/svg/icone_seta_direita.svg"
    );
    ...
    return (
        ...
        <div className={`card_links ${mostrarSpan ? "card_links_duvida" : ""}`}>
            ...
            <div className="conteudo">
                <ul>
                <li><img src={seta1} onClick={AbrirDuvida1}></img>Problemas para encontrar o produto desejado ?</li>
                {mostrarSpan && <Duvida />}
                <li><img src={seta2} onClick={AbrirDuvida2}></img>Meu pedido consta como entregue, mas eu não recebi.</li>
                <li><img src={seta3} onClick={AbrirDuvida3}></img>Qual é o processo de reembolso de acordo com as formas de pagamento ?</li>
                <li><img src={seta4} onClick={AbrirDuvida4}></img>Como acompanhar o status de rastreio do meu pedido ?</li>
                <li><img src={seta5} onClick={AbrirDuvida5}></img>Como faço para saber o prazo de entrega e modalidades disponíveis para o meu endereço ?</li>
                </ul>
